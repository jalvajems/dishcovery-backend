...
router.get('/foodie-management',verifyAccess, adminController.getAllFoodies.bind(adminController))
      ...
      .get('/blog-management',adminController.getAllBlogs.bind(adminController))
...
router.patch('/toggle-block/:id', adminController.blockUser.bind(adminController))
     ...
     .patch('/recipe-block/:id',adminController.blockRecipe.bind(adminController))
      .patch('/recipe-unblock/:id',adminController.unBlockRecipe.bind(adminController))
      .patch('/blog-block/:id',adminController.blockBlog.bind(adminController))
      .patch('/blog-unblock/:id',adminController.unBlockBlog.bind(adminController))
